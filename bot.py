...
your_name = "𝗣𝗔𝗥𝗦𝗔"
PHONE_NUMBER = '+15482588105'
CONFIG_FILE = "bot_config.json"
SESSION_FILE = "self_session.session"  # ← فایل جلسه
...
# ========== اگر فایل جلسه وجود نداشته باشه، از لاگین خودکار استفاده کن ==========
if not os.path.exists(SESSION_FILE):
    client = TelegramClient(SESSION_FILE, api_id, api_hash, timeout=30, retry_delay=5, auto_reconnect=True)
else:
    client = TelegramClient(SESSION_FILE, api_id, api_hash, timeout=30, retry_delay=5, auto_reconnect=True)
